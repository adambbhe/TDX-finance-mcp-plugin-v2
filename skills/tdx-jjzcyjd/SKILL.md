---
name: 基金重仓拥挤度
description: 用于基金重仓股拥挤度分析，聚焦机构行为 / 拥挤交易 / 风险管理 / 组合研究。适合判断某只基金重仓股到底是机构共识优质资产，还是已经过度拥挤、稍有不及预期就容易踩踏的标的。常用工具包括 `tdx-main-position`、`tdx-shareholder-research`、`tdx_quotes`、`tdx_kline`、`tdx_api_data`、`wenda_report_query`、`wenda_news_query`。
---
