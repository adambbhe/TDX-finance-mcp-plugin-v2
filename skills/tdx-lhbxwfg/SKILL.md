---
name: 查询龙虎榜席位风格
description: 用于龙虎榜席位风格、资金行为、游资研究与短线交易分析，聚焦营业部席位买卖明细、净额、席位标签和短线博弈结构。适用于回答“这只票龙虎榜怎么看”“哪些席位在主导”“更像接力还是兑现”“能否整理成龙虎榜复盘、资金行为报告、游资观察或金融文章”等问题。优先使用本仓库已实现的 `tdx_api_data`、`tdx_lookup_stock`、`tdx_quotes`、`tdx_kline`、`wenda_news_query`、`wenda_notice_query`，必要时补充 `tdx_screener`、`tdx_indicator_select`。
---
